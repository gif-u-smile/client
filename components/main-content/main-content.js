Vue.component('main-content', {
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-3 mb-3" v-for="(gif, index) in gifs">
                <span class="d-block bg-white">{{ gif.name }}</span> 
                <img v-bind:src="gif.gifURL" class="my-gif shadow mb-2" @click="sendInfo(gif.gifURL)" data-toggle="modal" data-target="#gifModal">
